...
\author{Jane Doe}
\date{}
\title{\ruby{山}{やま}の\ruby{上}{うえ}のカフェ (xeJC, subtree)}
\begin{document}
...
\begin{castpage}
  ...
  \addcharacter{さき（コウ）}{ゆかりの\ruby{親友}{しんゆう}、\ruby{自由人}{じゆうじん}}
\end{castpage}
...
\dialog{さき}{こんなに\ruby{歩}{ある}くとは\ruby{思}{おも}わなかったよ。\\
  \trans{没想到要走这么远。}}
